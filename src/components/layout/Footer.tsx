...
export default function Footer() {
  ...
  return (
    <footer className="bg-chrome text-chrome-fg py-10 mt-8 border-t border-chrome">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row flex-wrap justify-between gap-8 pb-8">
          ...
          <div className="flex-1 min-w-50">
            <div className="mb-4">
              ...
              <p className="text-sm text-chrome-muted mt-2">
                {t("description")}
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              {/* GitHub */}
              <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-chrome-muted hover:text-white transition-colors">
              ...
              {/* LinkedIn */}
              <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-chrome-muted hover:text-white transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-chrome-muted hover:text-white transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* X / Twitter */}
              <a href={socialLinks.x} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-chrome-muted hover:text-white transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              {/* TikTok */}
              <a href={socialLinks.tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-chrome-muted hover:text-white transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href={socialLinks.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-chrome-muted hover:text-white transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <ContactCTA
                ...
                aria-label="WhatsApp"
                className="text-chrome-muted hover:text-white transition-colors"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* Email */}
              <a href={`mailto:${siteConfig.email}`} aria-label="Enviar email a DaniDevCol" className="text-chrome-muted hover:text-white transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
          ...
          <address className="not-italic flex-1 min-w-50">
            ...
            <p className="text-base font-bold text-chrome-muted flex items-center gap-1">
        ...
        <div className="pt-8 border-t border-chrome flex flex-col sm:flex-row justify-between items-center gap-3 text-sm text-chrome-muted">
